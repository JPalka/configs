...
export PATH=$HOME/bin:$HOME/interactive-rebase-tool:$HOME/diff-so-fancy:/usr/local/bin:/usr/local/sbin:$PATH:$HOME/scripts:$HOME/scripts/i3xrocks_indicators:$HOME/.local/bin
